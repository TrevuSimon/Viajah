...
namespace Viajah.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ViajahContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Login,Senha,Nome,Email,DataCadastro,Moderador")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
